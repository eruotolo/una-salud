    ...
    <div class="row">
        <div class="col-12">
            <div class="card mb-4">
                ...
                <h3>Charlas y Conversatorios</h3>
                <a class="btn bg-gradient-info" href="?page=7">Nueva Charla</a>
                        ...
                        <table class="table align-items-center mb-0">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Documentos</th>
                                ...
                                ?>
                                    <tr>
                                        <td>
                                            <div class="d-flex px-2 py-1">
                                                ...
                                                <div class="d-flex flex-column justify-content-center">
                                                    <h6 class="mb-0 text-sm"><?php echo $row['id_char'] ?></h6>
                                                </div>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="d-flex px-2 py-1">
                                                ...
                                                <div class="d-flex flex-column justify-content-center" style="width:400px">
                                        ...
                                        <td class="align-middle">
                                            <form action="Charlas/create-doc.php" method="post">
                                        ...
                                        <td class="align-middle">
                                            <form action="Charlas/edit.php" method="post">
                                                <input type="hidden" name="id_char" id="id_char" value="<?php echo $row['id_char'] ?>">
                                                <input class="btn btn-default" type="submit" name="edit" value="Editar">
                                            </form>
                                        </td>
                                        <td>
                                            <a href="../Controller/Charlas.php?id_char=<?php echo $row['id_char'] ?>" class="btn btn-default" data-toggle="tooltip" data-original-title="Edit user">
                                                Elimnar
                                            </a>
                                        </td>
                                    </tr>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <p class="text-xs text-secondary mb-0"><?php echo $row['id_charla_doc'] ?></p>
                                        </td>
