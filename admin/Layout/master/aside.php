<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
  <div class="sidenav-header">
    ...
    <a class="navbar-brand m-0" href="https://unasalud.cl/admin/Layout/index.php?page=6">
      <img src="assets/img/logos/logo.svg" class="navbar-brand-img h-100" alt="logo">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link  " href="?page=3">
          ...
          <span class="nav-link-text ms-1">Charlas y Conversatorios</span>
        </a>
      </li>
      <li class="nav-item">
      ...
      <li class="nav-item">
        <a class="nav-link  " href="?page=5">
          ...
          <span class="nav-link-text ms-1">Otros Documentos</span>
        </a>
      </li>
      ...
      <li class="nav-item">
        <a class="nav-link active" href="?page=6">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <svg width="12px" height="12px" viewBox="0 0 46 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
      ...
      <!-- <li class="nav-item">
        <a class="nav-link  " href="../pages/?page=6">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
      ...
      <li class="nav-item">
        <a class="nav-link" data-open="modal1">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
  ...
  <div class="modal" id="modal1" data-animation="slideInOutLeft">
    <div class="modal-dialog">
      <section class="modal-content p-5">
        <div class="p-2">
          <h5>¿Seguro que desea salir?</h5>
        </div>
        <button class="btn bg-gradient-primary" aria-label="close modal" data-close>Volver</button>
        <a class="btn bg-gradient-secondary" href="../salir.php">Salir</a>
      </section>
    </div>
  </div>
