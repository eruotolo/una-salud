...
-- Tiempo de generación: 13-06-2022 a las 18:10:47
...
(53, 'Categoria 2', 'wss', 'https://ssss.cl', NULL, 11, 1, 1, 'Marcelo', 'marcelo@marcelo.cl'),
(54, 'camilo', 'aaaaa', 'https://ssss.cl', '2022-06-13 14:04:57', 11, 1, 2, 'sss', 'marcelo@marcelo.cl');
...
(36, 'Doc Ejemplo prueba web, con doble texto', 'DDODO', NULL, NULL, '2022-06-12 21:29:09', 'Jorge');
...
(5, 'arielinho', 'dasds', 'https://ssss.cl', '2022-06-07 00:00:00', 8, 2, 'Marcelo', ''),
(6, 'procedimiento autor', 'descripcion', 'https://ssss.cl', '2022-06-07 00:00:00', 11, 1, 'Jorge', 'marcelo@marcelo.cl'),
(7, 'msksks', 'isiissi', 'https://ssss.cl', NULL, 11, 1, 'Camilo lehue', 'marcelo@marcelo.cl');
...
--
ALTER TABLE `categorias_2`
  MODIFY `id_cat_2` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT de la tabla `charlas`
--
ALTER TABLE `charlas`
  MODIFY `id_char` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=55;
...
--
ALTER TABLE `procedimientos`
  MODIFY `id_proc` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
