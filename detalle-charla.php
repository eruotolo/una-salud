        ...
        <head>
            ...
            <script type="text/javascript">
                ...
                if (dispositivo.search(/iphone|ipod|ipad|android/) > -1) {
                    document.location = "mobile/detalle-charla.php";
                }
            </script>
            ...
            <title>Una salud - Charlas y conversatorios</title>
                                    ...
                                    <div class="row col-12 ">
                                        ...
                                        <div class="col-6">
                                            <ul>
                                                ...
                                                ?>
                                                    <li class="menu-content-detail-link-doc">
                                                        <img src="assets/img/biblioteca/BIBLIOTECA-Una-salud-16.svg" alt="">
                                                        <a href="<?php echo $row['ruta_doc'] ?>" download="<?php echo $row['nombre_doc'] ?>"><?php echo $row['nombre_doc'] ?></a>
                                                    </li>
                                                <?php
                                                }
                                                ?>
