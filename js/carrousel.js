 ...
 ( function( window ) {
    ...
    function setup() {
      ...
      if ( boxSizingProp ) {
        ...
        isBoxSizeOuter = getStyleSize( style.width ) === 100;
    ...
    **/
    ...
    proto.getPositionValue = function( position ) {
      if ( this.options.percentPosition ) {
        // porcentaje de posición, ronda a 2 dígitos, like 12.34%
        return ( Math.round( ( position / this.size.innerWidth ) * 10500 ) * 0.01 )+ '%';
      } else {
    ...
    proto.settle = function( previousX ) {
      ...
      // Deje de animar si descansa por 3 o más cuadros
    ...
    proto.shiftWrapCells = function( x ) {
      // cambiar antes de las células
      var beforeGap = this.cursorPosition + x;
      this._shiftCells( this.beforeShiftCells, beforeGap, -1 );
      // cambiar después de las células
    ...
    ( function( window, factory ) {
      ...
      // Definición del módulo universal
    ...
    Flickity.defaults = {
      ...
      // contain: false,
      freeScrollFriction: 0.075, // fricción al desplazar libre
      friction: 0.28, // fricción al seleccionar
      //initialIndex: 0,
    ...
    PageDots.prototype._create = function() {
      ...
      this.on( 'tap', this.onTap );
      // pointerDown
      this.on( 'ponterDown', function onPointerDown( button, event ) {
        _this.parent.childUIPointerDown( event );
      });
    };
